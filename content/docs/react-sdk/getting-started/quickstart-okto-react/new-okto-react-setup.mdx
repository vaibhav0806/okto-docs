...
<Step>
    ## Initialize the Okto SDK and Google OAuth Provider
...
<Step>
    ## Sample Login Page
    You can link to a sample login page template from the Okto template repo:
...
<Step>
    ...
    🎉 Congratulations! You now have a dApp powered by Okto. You can focus on your business logic and UI/UX now.
</Step>
