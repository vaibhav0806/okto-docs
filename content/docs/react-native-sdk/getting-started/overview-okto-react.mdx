...
description: The Okto React Native SDK is the easiest way to onboard your users to web3 in your React App.
full: false
---

## Introduction to Okto React Native SDK

The **Okto React SDK** offers a streamlined solution for integrating Web3 functionalities into your React Native application. With minimal setup time, you can effortlessly onboard your users to the Web3 ecosystem and provide them with a seamless experience.
