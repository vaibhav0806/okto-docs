...
By default, your project will use the **Sandbox** environment. To switch to the **Production** environment, please refer to our [Admin Panel documentation](/docs/react-native-sdk/developer-admin-dashboard/learn) for upgrade instructions.
</Callout>
